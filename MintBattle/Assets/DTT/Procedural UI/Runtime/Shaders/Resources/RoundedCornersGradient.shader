Shader "UI/RoundedCorners/RoundedCornersGradient" 
{
	Properties 
	{
		[HideInInspector] _MainTex ("Texture", 2D) = "white" { }
		[HideInInspector] _GradientTex ("TextureGradient", 2D) = "white" { }
	...
	SubShader 
	{
		...
		Pass 
		{
			...
			fixed4 frag(v2f i) : SV_Target {
				...
				return mixAlpha(Gradient(_GradientTex, roundedBoxUV, _GradientTex_ST,_Type) * tex2D(_MainTex,i.uv), i.uv, i.color, i.worldPosition, alpha);
			}
