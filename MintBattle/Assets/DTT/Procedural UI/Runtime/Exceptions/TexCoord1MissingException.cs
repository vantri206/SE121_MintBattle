...
namespace DTT.UI.ProceduralUI.Exceptions
{
    ...
    /// contain the additional shader channel <see cref="AdditionalCanvasShaderChannels.TexCoord1"/>
    /// even though it's required.
    /// </summary>
    public class TexCoord1MissingException : ProceduralUIException, IFixableCanvasException
    {
        /// <summary>
        /// <inheritdoc/>
        /// </summary>
        ...
        /// </summary>
        public TexCoord1MissingException(Canvas canvas) : this(canvas, PREFIX) { }
